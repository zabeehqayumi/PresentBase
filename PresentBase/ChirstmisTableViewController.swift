...
class ChirstmisTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let giftObjects = myGift[indexPath.row]
        
        cell.backgroundImageView.image = UIImage(named: giftObjects["image"]!)
        cell.nameLabel.text = giftObjects["name"]
        cell.itemLabel.text = giftObjects["item"]
